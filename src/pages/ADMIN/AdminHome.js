      ...
      <div className="container">
        ...
        <div className="row mb-5 justify-content-center">
          <div className="col-md-8 text-center">
            ...
            <p className="text-muted mb-0">Review all approved job opportunities.</p>
          </div>
        </div>
        <div className="row">
          {jobData.map((job) => (
            <div className="col-lg-6 mb-4" key={job._id}>
              <article className="bg-white shadow-sm h-100 overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="small mb-0"><span className="icon-room"></span> {job.jobdata?.location}</p>
                  <a href={job.jobdata?.website} target="_blank" rel="noopener noreferrer" className="btn btn-outline-secondary btn-sm mt-3">Company Website</a>
                </div>
              </article>
            </div>
          ))}
