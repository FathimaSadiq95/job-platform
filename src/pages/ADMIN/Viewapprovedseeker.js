...
const Viewapprovedseeker = () => {
  ...
  return (
    <>
      ...
      {seekerData.length === 0 && <div className="bg-white p-5 text-center shadow-sm"><p className="text-muted mb-0">No approved seekers found.</p></div>}
      <Footer />
    </>
  );
};

export default Viewapprovedseeker;
