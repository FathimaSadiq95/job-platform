    ...
    <header className="site-navbar mt-3">
      <div className="container-fluid">
        <div className="row align-items-center">
          <div className="site-logo col-6"><a href="/#home">JobBoard</a></div>

          <nav className="mx-auto site-navigation">
            <ul className="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              {/* <li><a href="/" className="nav-link active">Home</a></li> */}
                  {/* <li><a href="/Viewloginprovider#home-section" className="nav-link active">Job Providers</a></li> */}
                   {/* <li><a href="/Viewloginseeker#home-section" className="nav-link active">Job Seekers</a></li> */}
              {/* <li className="has-children">
                <a href="/Viewjob.js">Feedback</a>
                <ul className="dropdown">
                  <li><a href="/Viewloginfeedbackprovider#home-section">Provider Feedback</a></li>
                  <li><a href="/Viewloginfeedbackseeker#home-section">Seeker Feedback</a></li>
                </ul>
              </li> */}
            </ul>
          </nav>
          ...
          <div className="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div className="ml-auto">
              <a href="/#home" className="btn btn-primary border-width-2 d-none d-lg-inline-block"><span className="mr-2 icon-lock_outline"></span>Log In</a>
            </div>
